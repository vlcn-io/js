...
test("failing two -- discord: https://discord.com/channels/989870439897653248/989870440585494530/1051181193644736663", () => {
  ...
  db.execMany([
    ...
    `CREATE TABLE IF NOT EXISTS "todos__crsql_clock" ("id","col_name" NOT NULL,"col_version" NOT NULL, "db_version" NOT NULL,"site_id","seq" NOT NULL,PRIMARY KEY ("id", "col_name")    );`,
